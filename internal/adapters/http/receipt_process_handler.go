...
// gin-gonic: Web framework for building REST APIs in Go
// uuid: Package to generate unique identifiers (UUIDs)
// domain: Package that holds the domain models (like Receipt)
// internalHttp: The service interface for receipt processing (from the ports/http package)
// netHttp: Standard Go package for HTTP-related constants (like StatusOK, StatusBadRequest)
import (
	"github.com/gin-gonic/gin"
	"github.com/google/uuid"
	"go-receipt-processor/internal/domain"
	internalHttp "go-receipt-processor/internal/ports/http" // Alias this import to avoid conflict with the gin package
	netHttp "net/http"                                      // Alias net/http to avoid name conflicts
)
